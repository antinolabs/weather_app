...
class AppColors {
  static const primary = Color(0xFF08244F);
  static const primaryInner = Color(0xff000f26);
  ...
  static const errorColor = red240;
  static const blueLightSelectedColor = Color.fromARGB(255, 202, 215, 254);

  static const primary30 = Color.fromARGB(76, 77, 123, 212);
  static const primary10 = Color.fromARGB(25, 77, 123, 212);
}

class ContainerDecoration {
  ///Application Primary Gradient
  static List<BoxShadow> getLightBoxShadow(Color? color) {
    return [
      BoxShadow(
          offset: Offset(0, 1),
          blurRadius: 7,
          color: color ?? AppColors.shadowColor2)
    ];
  }
  ...
  static const darkBoxShadow = [
    BoxShadow(
        offset: Offset(2, 2), blurRadius: 2, color: AppColors.shadowColor2),
    BoxShadow(
        offset: Offset(-2, 2), blurRadius: 2, color: AppColors.shadowColor2),
  ];
}